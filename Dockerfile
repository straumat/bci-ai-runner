...
RUN apt-get update && \
    apt-get install -y apt-utils g++ make cmake freeglut3-dev libc6-dev-i386 mesa-common-dev mesa-utils-extra libgl1-mesa-dev libglu1-mesa-dev libglapi-mesa libxi-dev libxinerama-dev libxcursor-dev libxrandr-dev libxmu-dev libxi-dev libx11-dev xorg-dev
